...
export function Hero() {
  ...
  return (
    ...
    >
      {/* Background image */}
      <div className="absolute inset-0 w-full h-full pointer-events-none z-0 max-md:scale-[0.85] max-md:[transform-origin:right_center] max-md:[clip-path:none]" style={{ clipPath: 'inset(0 4% 0 0)' }}>
        <img
